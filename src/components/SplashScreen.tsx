            ...
            <div className="w-32 h-32 bg-white rounded-lg p-4 shadow-lg">
              ...
              >
                ...
                <path
                  ...
                  fill="#EF940E"
                />
                {/* White windows and details */}
                <path
                  d="M40.2115 40.686H46.173V46.9237C46.173 47.5 46.4 47.9 47 48H73C73.6 47.9 73.783 47.5 73.783 46.9237V40.686H79.7445C79.7445 45 79 47 76 47H44C41 47 40.2115 45 40.2115 40.686Z"
                  fill="white"
                />
                {/* Bus windshield */}
                <rect
                ...
                <rect
                  ...
                  fill="white"
                />
                {/* Passenger windows - two circular ones */}
                <circle cx="49.1312" cy="63.5" r="3" fill="white" />
                <circle cx="70.8248" cy="63.5" r="3" fill="white" />
              </svg>
            </div>
          </div>
          {/* App Name */}
